...
\begin{description}
\item[scalar] is an array with just a single element.
\item[vector] is a two-dimensional array that has a size 1-by-N (row) or N-by-1 (column).
\item[matrix] is a two-dimensional array.
